...
class Requester
{
    ...
    public function getWeatherData($params) {
        ...
        if ($params->queryType == "all") {
            ...
            $query = "SELECT SQL_CALC_FOUND_ROWS wd.ID, wm.ModuleName, wm.ModuleID, wm.Description, wd.Temperature1, wd.Temperature2, wd.Temperature3, wd.Humidity1, wd.Humidity2, wd.Humidity3, wd.Pressure1, wd.Pressure2, wd.Pressure3, wd.Illumination, wd.CO2, wd.MeasuredDateTime FROM WeatherData wd JOIN WeatherModule wm ON wm.MAC = wd.ModuleMAC ORDER BY $params->sortBy $params->sortAscending LIMIT $rowsToSkip, $params->pageSize";
        } else {
